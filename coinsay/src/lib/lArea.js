 ...
 window.lArea = (function() {
    var MobileArea = function() {
        ...
        this.data;
        this.index = 0;
        this.value = [0, (new Date).getMonth(),(new Date).getDate()-1];//标注默认第几个开始
    }
    MobileArea.prototype = {
        ...
        finish: function(e) {
            ...
            _self.trigger.innerHTML = cityText;
 ...
 function initArray(startYear,count) {
			function checkM(arg3,arg4){
				var arg1 = arg3+startYear;
				var arg2 = arg4+1;
				if(arg2 ==1||arg2 ==3||arg2 ==5||arg2 ==7||arg2 ==8||arg2 ==10||arg2 ==12){
					return 31;
				}else if(arg2==2){
					if(arg1%4==0 && arg1%100!=0){
						return 29;
					}else{
						return 28;
					}
			...
			for(var k = 0; k < count; k++) {
				...
				var monStart=0;var dayStart = 0;
				for(var j = monStart; j < 12; j++) {
					var monthObj = new Object();
					var dayArray = new Array();
					 var  iLength = checkM(k,j);
					for(var i = dayStart; i < iLength; i++) {
					...
					monthObj.id = j+1;
					monthObj.name = j+1;
					monthObj.child = dayArray;
					monthArray[j] = monthObj;
				}
				yearObj.id=k;
				yearObj.name=startYear+k;
				yearObj.child=monthArray;
				yearArray[k]=yearObj;
			}
			return yearArray;
		}

window.lAreaData = initArray((new Date).getFullYear(),10);
