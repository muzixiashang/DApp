<template>
	<div class="context">
		<div class="title">
			<a href="javascript:history.go(-1)"><img src="../../common/img/fanhuijian.png" class="back" /></a> 投票认证
		</div>
		<div id="view1" v-if="currView==0">
			<div class="rnaBox">y
				<div class="rnaPicUp">
					<img class="fl" src="../../common/img/ttcHbVote1.png" id="hit1" data-state="0" />
					<p>请严格按照示例图上传完整截图</p>
				</div>
				<div class="rnaPicDown">
					<img class="fr" src="../../common/img/ttcHbVote2.png" id="hit2" data-state="1" />
					<p>请严格按照示例图上传完整截图</p>
				</div>
			</div>
		...
		<div id="view2" v-if="currView==1">
			<ul>
				<li @click="selectPayWay(0)">
					<span>存放在个人数字资产</span>
					<img src="../../common/img/voteSel1.png" v-if="selState!=0" />
					<img src="../../common/img/voteSel2.png" v-if="selState==0" />
				</li>
				<li @click="selectPayWay(1)">
					<span>提取TTC币到个人钱包</span>
					<img src="../../common/img/voteSel1.png" v-if="selState!=1" />
					<img src="../../common/img/voteSel2.png" v-if="selState==1" />
				</li>
				<!--<li @click="selectPayWay(2)">
					<span>提取等价值HT到个人钱包</span>
					<img src="../../common/img/voteSel1.png" v-if="selState!=2" />
					<img src="../../common/img/voteSel2.png" v-if="selState==2" />
				</li>-->
		...
		methods: {
			...
			submitsave: function() {
				...
				if(vm.selState == 0) {
					$.ajax({
						type: "post",
						url: contextPath + "/liyu_game/api/authentication/submitliyusave",
						async: true,
						dataType: "json",
						data: {
			...
			getDefaultData: function() {
				...
				$.ajax({
					type: "post",
					url: contextPath + "/liyu_game/api/authentication/queryliyuauthentication",
					async: true,
					dataType: "json",
					data: {
						token: localStorage.token
			...
			setImg: function() {
				...
				$.ajax({
					type: "post",
					url: contextPath + "/liyu_game/api/authentication/addliyuauthentication",
					async: true,
					dataType: "json",
					data: {
						token: localStorage.token,
