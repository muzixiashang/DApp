    ...
    <div class="body">
        ...
        <div class="record">
            <div class="logo">
             ...
             <p class="content">
                <span class="s1">提币数量</span>
                <span class="s2 s3">{{details.ttcnum}}&nbsp;TTC</span>
            </p>
             <p class="content"  v-if="details.state==1">
                <span class="s1">手续费</span>
                <span class="s2 s3">-100TTC&nbsp;</span>
            </p>
            <p class="content">
            ...
            <p class="content">
             ...
             <p class="content nowrap">
                <span class="s1">提币地址</span>
                <span class="s3 hide">{{details.address}}</span>
            </p>
            <p class="content">
