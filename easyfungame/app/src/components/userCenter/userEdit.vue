<template>
	<div class="context">
		<div class="title">
			<router-link to="/userCenter"><img src="../../common/img/userCenter/arrowsb.png" alt="" class="back" /></router-link> 个人信息
		...
		<div class="userCenter">
			...
			<li>
				...
				<input type="text" maxlength="8" class=" fr nickNameInput" id="address" :value="userData.address" placeholder="设置收货地址" />
			</li>
			<router-link to='/privacy'>
				<li>
					<span class="lable">隐私设置</span>
					<span class="point"></span>
				</li>
			</router-link>

			<router-link to='/advancedSetting'>
				<li>
					<span class="lable">高级设置</span>
					<span class="point"></span>
	...
	export default {
		...
		methods: {
			...
			save: function() {
				...
				$.ajax({
					type: "post",
					url: contextPath + "/liyu_game/api/userInfo/updateUserInfo",
					async: true,
					dataType: "json",
					data: {
